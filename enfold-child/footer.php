...
<?php
			...
			?>
                        ...
                        <div style="float:right;margin-right:35px;"><span class="copyright" style="float:right;display:block"><a href="<?php echo get_permalink(8309); ?>"><?php echo get_the_title(8309); ?></a> <a href="<?php echo get_permalink(8305); ?>"><?php echo get_the_title(8305); ?></a></span></div>
...
<script>
  // Wistia Autoplay if from Mailchimp code
  // Update 'wemail' to your string
  if (/foreign_data/.test(location.href)) {
    wistiaEmbed.play();
  }
  </script>
...
<script type="text/javascript">
	  jQuery(document).ready(function() {
        var href = jQuery("body.attachment-pdf p.attachment a").attr('href');
        var start = '<iframe src="//docs.google.com/viewer?url=';
        var end = '&amp;hl=en_US&amp;embedded=true" class="gde-frame" style="width:100%; height:500px; border: none;" scrolling="no"></iframe>';
        var fin = start.concat(href,end);
        jQuery("p.attachment").prepend(fin);  
        });
</script>
</body>
</html>